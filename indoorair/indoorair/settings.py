"""
Django settings for indoorair project.
...
SECRET_KEY = 'n4@_pd7#0ysv_s$gc5guc-q#ny5(l_hri(t(-f@r=*(f7zix17'
...
WSGI_APPLICATION = 'indoorair.wsgi.application'
...
REST_FRAMEWORK = {
   'DEFAULT_AUTHENTICATION_CLASSES': (
       ...
       'foundation.custom.CsrfExemptSessionAuthentication',
   ),
